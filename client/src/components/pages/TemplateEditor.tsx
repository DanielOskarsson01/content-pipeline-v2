      ...
      {isEdit && template && (
        <>
          ...
          <ExecutionPlanSection
            ...
            isPending={updateMutation.isPending}
          />
          {/* Cards + Routing are now edited in the run view (Step-7 routing body + variant panes);
              the dead legacy textareas were removed (card-write item 9). Escalation stays here. */}
